...
export const Route = createFileRoute("/map")({
  ...
  head: () => ({
    meta: [
      { title: "Mission Map — Cross-Cultural Ministry" },
      { name: "description", content: "Interactive geographic map of every Cross-Cultural Ministry field, area, and church planter." },
      { property: "og:title", content: "Mission Map — Cross-Cultural Ministry" },
      { property: "og:description", content: "Interactive geographic map of every Cross-Cultural Ministry field, area, and church planter." },
      ...
      { name: "twitter:title", content: "Mission Map — Cross-Cultural Ministry" },
      { name: "twitter:description", content: "Interactive geographic map of every Cross-Cultural Ministry field, area, and church planter." },
