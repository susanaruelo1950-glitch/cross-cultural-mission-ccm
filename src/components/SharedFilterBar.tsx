...
/**
 * Region / Province / Phase filter bar. State is stored in the shared filter
 * store, so it stays in sync across the Dashboard, Missionary Directory, and
 * the AI Assistant's answer scope.
 */
export function SharedFilterBar({
  ...
  const active = filters.regionId !== ALL || filters.provinceId !== ALL || filters.phaseId !== ALL;
  ...
  return (
    ...
    >
      <div className="mb-2 flex flex-wrap items-center justify-between gap-2">
        ...
        {active ? (
          <Button size="sm" variant="ghost" className="h-7 rounded-full text-xs" onClick={reset}>
